...
export const metadata: Metadata = { title: "To inspect · DRISHTI-G" }
...
export default async function OfficerInspectPage() {
    ...
    return (
        <div>
            <PageHeader title="Work to inspect" description={description} />


            <OfficerDeskClient tasks={res.items} scope="awaiting" />
        </div>
    )
}
